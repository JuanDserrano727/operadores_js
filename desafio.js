...
console.log(mayorQueCincuenta(200))
...
console.log(combinarNombres('juan', 'david'));
...
console.log(obtenerAreaRectangulo(30,15));
...
console.log(areaDelTriangulo(25,14));
